...
phtha<- c('adjusted_MEP','adjusted_MCPP','adjusted_MBZP','adjusted_MBP','adjusted_MIBP','adjusted_MEHP','adjusted_MEOHP','adjusted_MEHHP','adjusted_MECPP','adjusted_MCIOP','adjusted_MCINP','adjusted_MEHTP','adjusted_MEOHTP','adjusted_MEHHTP','adjusted_MECPTP')
...
tabel<- flextable(as_grouped_data(phtha_mixreg1_coefs_data, groups = "phtha")) %>%          color(~sig == "*", ~conf.low, color = "red")%>% 
...
## put result into one table
tabel<- flextable(as_grouped_data(phtha_multireg1_pcv2_coefs_data, groups = "phtha")) %>%          color(~sig == "*", ~conf.low, color = "red")%>% 
        color(~sig == "*", ~conf.high, color = "red")%>%
        theme_box() 
...
## put result into one table
tabel<- flextable(as_grouped_data(phtha_multireg1_pgv3_coefs_data, groups = "phtha")) %>%          color(~sig == "*", ~conf.low, color = "red")%>% 
        color(~sig == "*", ~conf.high, color = "red")%>%
        theme_box() 
