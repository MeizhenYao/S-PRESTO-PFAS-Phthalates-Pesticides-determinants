...
phtha_mixreg1 <-
  lapply(phtha, function(x){
    ...
    lmer(formula = substitute(i ~ pcv1_highest_education_completed_recat + fruit_sc + vegetable_sc + Styrofoam_boxes + (1 | Subject_ID),
                           list(i = as.name(x))),
      data = phtha_log)
...
final_model3<- phtha_mixreg1_coefs_data %>% 
                filter(phtha_group == "HMWPs")

## put result into one table
tabel<- flextable(as_grouped_data(final_model3, groups = c("phtha_group","phtha_parent","phtha"))) %>%          
        color(~sig == "*", ~conf.low, color = "red")%>% 
        color(~sig == "*", ~conf.high, color = "red")%>%
        theme_box() 
...
####### extract results
# write_csv(final_model3, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/final_model3.csv")
...
model1<- phtha_multireg1_pcv2_coefs_data
...
######## extract results
parity<- phtha_multireg1_pcv2_coefs_data %>% 
         filter(term == "pcv1_parity_recat>= 1")
...
####### extract results
write_csv(phtha_model1, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/phtha_model1_pcv2_raw.csv")
...
######## extract results
fish<- phtha_multireg1_pcv2_coefs_data %>% 
       filter(term == "TotalFish_sc")
...
######## extract results
fast_food<- phtha_multireg1_pcv2_coefs_data %>% 
       filter(term == "Fast_food_sc")
```
...
######## extract results
fruit<- phtha_multireg1_pcv2_coefs_data %>% 
        filter(term == "fruit_sc")
```
...
######## extract results
vegetable<- phtha_multireg1_pcv2_coefs_data %>% 
        filter(term == "vegetable_sc")
...
######## extract results
Styrofoam_boxes<- phtha_multireg1_pcv2_coefs_data %>% 
            filter(term == "Styrofoam_boxesYes")
...
######## extract results
Plastic_boxes<- phtha_multireg1_pcv2_coefs_data %>% 
            filter(term == "Plastic_boxesYes")
...
######## extract results
write_csv(phtha_model2, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/phtha_model2_pcv2_raw.csv")
...
####### extract results
write_csv(phtha_model1, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/phtha_model1_pgv3_raw.csv")
...
######## extract results
write_csv(phtha_model2, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/phtha_model2_pgv3_raw.csv")
