...
whole_cohort$GQ1_Place_BF_new_v4<- factor(whole_cohort$GQ1_Place_BF_new_v4,
                                       levels = 1:3,
                                       labels = c("Eat at home", "Eat outside", "Packed from home/ Take out from outside"))
...
table_wide<- data.frame(label = c("Breakfast: Eat at home",                                  
                        ...
                        dim2_coordinates = round(var$coord[, 2], 2)) %>% 
...
tbl<- ggplot(table, aes(x=parameter, y=label))  + 
      ...
      scale_x_discrete(labels = c("dim1_contribution" = "Dim1\ncontribution", 
                                  ...
                                  "dim2_contribution" = "Dim2\ncontribution", 
                                  "dim2_coordinates" = "Dim2\ncoordinates")) +
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/figure4.jpeg",
...
fp<- annotate_figure(fp, 
                top = text_grob("", color = "red", face = "bold", size = 17),
                fig.lab = "(B) Contribution and Coordinates of Variable Categories to the First Two Dimensions", 
                fig.lab.pos = c("top.left"),
                fig.lab.face = "bold",
                fig.lab.size = 20)
...
# cor(PFAS_log$mca_dim1, PFAS_log$Fast_food_sc)
# cor(PFAS_log$mca_dim2, PFAS_log$Fast_food_sc)
```
