...
library(glmnet)
#------------------------------------------------------------import dataset
figures10_data<-  read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data_input/PFAS_mca_strata.csv")
...
figures10_data$package<- factor(figures10_data$package,
                                  levels = c("Low-tendency-packaging", "High-tendency-packaging"),
                                  labels = c("Consume packaged food: low tendency", "Consume packaged food: high tendency"))
...
figure2_1<- ggplot(figures10_data_1,aes(y=term)) +
  ...
  facet_grid(package~PFAS,  space = "free_y")+
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/supp_figure11.jpeg",
