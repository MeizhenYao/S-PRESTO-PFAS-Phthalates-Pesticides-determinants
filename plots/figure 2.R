...
#------------------------------------------------------------import dataset
figure2_data<-  read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data_input/PFAS_model1.csv")
...
figure2_data_1<- figure2_data %>% 
                 filter(PFAS_name %in% c('PFOS', 'PFOA', 'PFNA', 'PFHxS'))
...
figure2_1<- ggplot(figure2_data_1,aes(y=term)) +
  ...
  facet_grid(covariates~PFAS_name, scale="free", space = "free_y")+
...
figure2_data_2<- figure2_data %>% 
  filter(PFAS_name %in% c('PFDA', 'PFHpA', 'PFHpS'))
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/figure2.jpeg",
