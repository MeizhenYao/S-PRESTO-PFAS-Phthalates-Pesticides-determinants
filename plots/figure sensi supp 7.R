...
library(glmnet)
#------------------------------------------------------------import dataset
figure2_data<-  read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/code/R/chemical & covariates/plot_data_input/PFAS_FFQ_mca.csv")
...
figure2_2<- ggplot(figure2_data_2,aes(y=covariates)) +
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/Supp_figure7.jpeg",
     units="in", width=18, height=5, res=500)
