...
library(ggh4x)
#------------------------------------------------------------import dataset
figure3_data<-  read.csv("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/plot_data_input/final_model3.csv")
...
figure3_data$term<- factor(figure3_data$term,
                           ...
                           labels = c("pcv1_highest_education_completed_recatPrimary/Secondary/Post_secondary",
                                      "Fruit Intake",
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/Supp_figure5.jpeg",
