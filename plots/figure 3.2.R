...
figure3_data$covariates<- factor(figure3_data$term,
                                 levels = c("Total Fish Intake", 
                                            ...
                                            "Styrofoam Boxes Usage Frequency",
                                            "Plastic Boxes Usage ",
                                            "Plastic Boxes Usage Frequency",
                                            "Canned Usage ",
                                            "Canned Usage Frequency"))

figure3_data$level<- ifelse(is.na(figure3_data$level)==TRUE, " ", figure3_data$level)
...
jpeg("C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/code/R/chemical & covariates/paper plot/figure3.2.jpeg",
