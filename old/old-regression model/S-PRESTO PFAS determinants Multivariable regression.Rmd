...
## model2: one factor + sociodemographic factors
## Parity
```{r, message=FALSE,warning=FALSE}
...
PFAS_multireg1 <-
   c(lapply(PFAS_cont, function(x){
    ...
    glm(formula = substitute(i ~ pcv1_parity_recat + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat, 
                           list(i = as.name(x))),
      data = PFAS_log,
      family = gaussian())
    }),
...
######## extract results
parity<- PFAS_multireg1_coefs_data %>% 
...
PFAS_multireg1 <-
   c(lapply(PFAS_cont, function(x){
    ...
    glm(formula = substitute(i ~ Fast_food_sc  + Plastic_boxes_freq_mean_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat, 
                           list(i = as.name(x))),
      data = PFAS_log,
      family = gaussian())
    }),
...
<!--     glm(formula = substitute(i ~ Styrofoam_boxes_freq_mean_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
...
<!--     glm(formula = substitute(i ~ Plastic_boxes_freq_mean_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
...
<!-- ######## extract results -->
<!-- FFQ_class_v1<- PFAS_multireg1_coefs_data %>% -->
<!--             filter(term %in% c("FFQ_class_v1Home", "FFQ_class_v1Outside")) -->
<!-- ``` -->
...
<!--               filter(term %in% c("FFQ_class_v2Eat in outside & take out", "FFQ_class_v2Take out & other"))  -->

<!-- ```  -->

<!-- ## FFQ mca dim2 - packaging (dichotomous) -->
<!-- ```{r, message=FALSE,warning=FALSE} -->
...
<!--     glm(formula = substitute(i ~ packaging + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
...
<!-- PFAS_multireg1_coefs_data<- PFAS_multireg1_coefs_data %>%  -->
<!--                             inner_join(PFAS_info, by="PFAS_name") %>%  -->
<!--                             filter(term %in% c("packagingMid-tendency packaging", "packagingHigh-tendency packaging")) -->
...
<!-- ######## extract results -->
<!-- packaging<- PFAS_multireg1_coefs_data %>%  -->
<!--             filter(term %in% c("FFQ_class_v2Eat in outside & take out", "FFQ_class_v2Take out & other")) -->
<!-- ``` -->
...
<!--     glm(formula = substitute(i ~ FFQ_class_v3 + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
...
<!--     glm(formula = substitute(i ~ clust_hcpc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
...
PFAS_multireg1 <-
   c(lapply(PFAS_cont, function(x){
    ...
    glm(formula = substitute(i ~ occupation + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat, 
                           list(i = as.name(x))),
      data = PFAS_log,
      family = gaussian())
    }),
...
######## extract results
Occup<- PFAS_multireg1_coefs_data
```
...
<!--     glm(formula = substitute(i ~ occupation_v2 + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat,  -->
<!--                            list(i = as.name(x))), -->
<!--       data = PFAS_log, -->
<!--       family = gaussian()) -->
<!--     }), -->
