...
####### extract results
# write_csv(phtha_model1, "C:/Users/yaom03/OneDrive - The Mount Sinai Hospital/Documents/Projects/S-PRESTO/code/R/chemical & covariates/plot_data/phtha_model1_raw.csv")
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ vegetable_boil_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ vegetable_SF_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ Styrofoam_boxes_freq_mean + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ Plastic_boxes_freq_mean + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ Canned + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pcv2 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ Canned_freq_mean + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pcv2,
      family = gaussian())
...
phtha_multireg1_pgv3 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pgv3,
      family = gaussian())
...
phtha_multireg1_pgv3 <-
  lapply(phtha, function(x){
    ...
    glm(formula = substitute(i ~ TotalFish_sc + ethnicity_specified_recat + age_at_recruitment_cat + pcv1_highest_education_completed_recat + pcv1_household_income_recat , 
                           list(i = as.name(x))),
      data = phtha_log_pgv3,
      family = gaussian())
