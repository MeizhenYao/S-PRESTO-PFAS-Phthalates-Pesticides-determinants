...
pm1_1 = p1 + theme(axis.text.x= element_text(face="bold", angle = 0, size = 10),
...
pm2_1 = p2 + theme(axis.text.x= element_text(face="bold", angle = 0, size = 10),
                 axis.text.y = element_text(size = 9,face = "bold"),
                 legend.text = element_text(size = 9,face = "bold"),
                 legend.title = element_text(size = 10,face = "bold"),
                 plot.title = element_text(size = 10,face = "bold"),
...
pm3_1 = p3 + theme(axis.text.x= element_text(face="bold", angle = 0, size = 10),
                 axis.text.y = element_text(size = 9,face = "bold"),
                 legend.text = element_text(size = 9,face = "bold"),
                 legend.title = element_text(size = 10,face = "bold"),
                 legend.position = "top",
